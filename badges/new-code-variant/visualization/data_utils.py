...
def convert_qa_example_to_features(example, tokenizer, max_seq_length,
    ...
    window_list = [] # ADDED: We added a list that contains all windows (doc_spans)
    for (doc_span_index, doc_span) in enumerate(doc_spans):
        ...
        window_list.append(QAInputFeatures(
            unique_id=unique_id,
            example_index=0,
    ...
    return window_list # ADDED: We return *all* windows instead of just one
